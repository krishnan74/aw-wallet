...
const Navbar = () => {
  ...
  return (
    <div className="flex flex-wrap justify-center items-center h-fit py-5 border-b px-4 md:justify-between gap-x-10  md:px-8 lg:px-16 gap-y-5">
      ...
      <div className="hidden text-[#444] md:flex gap-6 lg:gap-1 border-3 font-semibold">
          ...
          if (index === 2) {
            return (
              <div key={`dropdown-${index}`}>
                ...
                <Link
                  href={"#"}
                  className="text-sm  hover:bg-gray-50 px-3 py-2"
                >
                  Limited Edition
                </Link>
              </div>
      ...
      <div className="flex gap-4 md:gap-6 justify-center max-xl:w-full items-center">
        ...
        <div className="flex gap-2 md:gap-3">
          <Link
            href={"/"}
            className="rounded-full text-[#184A2C] border border-[#184A2C] h-[30px] w-[30px] flex justify-center items-center "
          >
